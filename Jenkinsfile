/* pipeline 변수 설정 */
def DOCKER_IMAGE_NAME = "simscom/project-repo"           // 생성하는 Docker image 이름
def DOCKER_IMAGE_TAGS = "testproject"  // 생성하는 Docker image 태그
...
podTemplate(label: 'builder',
            containers: [
                containerTemplate(name: 'gradle', image: 'gradle:7.6.1-jdk8', command: 'cat', ttyEnabled: true),
                ...
                withCredentials([usernamePassword(
                    ...
                    passwordVariable: 'PASSWORD')]) {
                        ...
                        sh """
                            ...
                            --docker-email=simscom72@gmail.com \
                            -n ${NAMESPACE}
                        """
